...
from .access import (
    ...
    can_reconcile_controls, can_view_bank_reconciliation, can_view_ledger, can_view_advances, department_for_user,
...
def workspace(request):
    ...
    return render(request, "accounting/workspace.html", {
        ...
        "can_view_advances": can_view_advances(request.user),
...
def subsidiary_controls(request):
    ...
    return render(request, "accounting/subsidiary_controls.html", {
        ...
        "advance_sources": JournalSubsidiaryLine.objects.filter(category=JournalSubsidiaryLine.ADVANCE,
            ...
            entry__entry_date__lte=as_of_date).exclude(entry__source_snapshot__has_key='advance_application_correction').select_related("entry", "entry__fund").order_by("entry__entry_date", "pk"),
