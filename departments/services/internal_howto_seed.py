...
ACCOUNTING_GUIDES = (
    ...
    },
    {
        ...
        "order": 80,
        "steps": (
            ("Find the exact Accounting or custody work", "Use the Finance Queue's stage, transaction type, requesting office, next-attention, print/custody, or plain search filters. Choose Needs signing copy, Ready to print, Printed but not assembled, Circulating, or Signed packet returned when following paper work. Export DV custody history when a portable version/reprint/packet/signature schedule is needed.", "The screen and export use the same role scope and filters, while every superseded print version remains visible in the register.", "A custody register is not a wet signature, approval, payment authority, or proof that the starter/pilot form is locally accepted.", "Open Finance Queue", "vouchers:workspace"),
