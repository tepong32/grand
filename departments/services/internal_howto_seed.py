...
FINANCE_MY_WORK_GUIDES = {
    "accounting": {
        ...
        "steps": (
            ...
            ("Read an exact work item", "For Finance Setup, discovery decisions, payable review, DV preparation, controlled signing-copy/print/packet custody, earliest wet-signature return, Accounting validation, JEV preparation/posting, Field-operation cycle and nested actions, and Local Forms, read the stable Task ID, controlled type, source reference, action, gate, permitted queue, target when retained, timing basis, source version, and exception before opening the record.", "The same source and action keep the same Task ID while applicable. Accounting validation and posting use current-office and maker-checker boundaries; print/custody steps do not collapse into one action.", "The item is a read-only pointer. Stop on any one-cent DV, obligation, allocation, or debit-credit difference and on a closed period; a screen receipt is not the physical signature or a posting action.", "Review My Work", "finance_operations:my_work"),
