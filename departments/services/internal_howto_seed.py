...
ACCOUNTING_GUIDES = (
    ...
    },
    {
        ...
        "steps": (
            ...
            ("Accept the actual local form", "Open Local form acceptance after template activation. Enter the authority, blank/redacted reference, familiar sections, optional/repeating behavior, signatories, copies, deadlines, retention, paper, printer, pagination, overflow, and accessibility instructions. Perform every practical test and send each attempt to a different witness.", "A different form reviewer accepts only the exact checksummed reference and activated template after all required categories have a current witnessed pass.", "Inventory-only records and synthetic starters cannot be accepted. Failed attempts remain visible; accepted form changes use a successor and repeat practical testing.", "Open Local form acceptance", "reporting:local_form_workspace"),
...
BUDGET_GUIDES = (
    {
        ...
        "steps": (
            ...
            ("Record local form acceptance", "Open Local form acceptance and describe the exact Budget form in ordinary terms: authority, blank/redacted reference, required and optional sections, signatories, copies, recipients, deadlines, paper, printer, pagination, overflow, and accessibility. Link only the activated report template and retain independently witnessed tests.", "The accepted form version pins the exact template, reference, practical results, people, and SHA-256 evidence while prior versions remain traceable.", "A technically balanced Budget report or public blank form does not establish local acceptance. Repeat testing through a successor whenever the accepted form changes.", "Open Local form acceptance", "reporting:local_form_workspace"),
...
TREASURY_GUIDES = (
    {
        ...
        "steps": (
            ...
            ("Witness the actual Treasury form", "Use Local form acceptance to link the activated register or Finance workbook, retain the blank/redacted reference, and record the actual signatory, copy, recipient, custody, deadline, paper, printer, overflow, and continuation rules. Perform or independently witness the applicable practical tests.", "Only a different reviewer can accept the exact checksummed form after every current test passes; earlier failed attempts remain visible.", "Do not mark printer/form-stock testing not applicable when Treasury actually prints, signs, releases, or files paper. Accepted changes use a successor and a fresh test cycle.", "Open Local form acceptance", "reporting:local_form_workspace"),
...
ACCOUNTING_GUIDES = ACCOUNTING_GUIDES + (
    {
        ...
        "steps": (
            ...
            ("Approve the field-cycle rule", "For the candidate cutover cycle, set the locally accepted minimum consecutive-cycle count, whether a controlled parallel run is mandatory, and the retained local authority, accepted rules/forms, and field-proof basis. Submit it to a different reviewer.", "An approved checksum-backed plan states the actual local qualification rule without hard-coding the starter as COA or DBM policy.", "The starter minimum of two is editable. Replace it only with a retained local decision; do not weaken it merely to pass the gate.", "", ""),
            ("Build the predecessor chain", "Add each independently reconciled field cycle from oldest to newest. Reference the retained field-execution packet and the exact accepted rules, forms, reports, and print layouts used; submit each row for independent acceptance.", "The accepted rows form one uninterrupted predecessor chain ending at the candidate and include a parallel cycle when the approved plan requires it.", "Synthetic UAT alone is not field execution. Returned or altered evidence needs correction or a successor cycle; accepted evidence is immutable.", "", ""),
            ("Prepare authority last", "After the field chain and all seven stakeholder kinds pass, record the authority matrix, exact cutover date/scope, opening reconciliation, continuity evidence, rollback criteria, legacy retention plan, and retained signed authority record reference, checksum, and custodian.", "A different authorized user can record go/no-go; GRAND becomes authoritative only for an authorized exact scope/date.", "GRAND does not create or store the signature image. Do not treat configuration activation, pilot reconciliation, or report agreement as implicit cutover.", "", ""),
