...
REQUESTING_GUIDES = REQUESTING_GUIDES + (
    {
        ...
        "steps": (
            ...
            ("Read an exact work item when available", "For Finance Setup, discovery decisions, Budget versions/allotments/obligations, payable preparation/review, DV preparation/controlled custody/wet-signature return, Accounting validation/JEV preparation/posting, Treasury check preparation/individual release, remittance, cash policy/position, Field-operation cycle and nested actions, and Local forms, read the stable Task ID, source reference, exact action and gate, permitted queue, scope, timing basis, source version, and exception before opening the record.", "The same source and action keep the same Task ID while applicable, while separate actions on one source remain distinguishable.", "The item does not copy, assign, approve, validate, sign, print, issue, release, remit, reserve, post, or complete the source record. Budget, payable, DV, allocation, JEV, payment-instrument, remittance, and cash-position differences must reconcile to zero before the governed next step.", "Review My Work", "finance_operations:my_work"),
