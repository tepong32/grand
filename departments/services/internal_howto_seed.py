...
ACCOUNTING_GUIDES = (
    ...
    },
    {
        ...
        "steps": (
            ...
            ("Verify governed tax filing evidence", "When a released governed-tax batch carries submitted filing evidence, compare its form/period, actual channel, filing acknowledgement, payment proof, retained source-schedule SHA-256, and custody reference to the external evidence packet.", "A different Accounting reviewer verifies the exact checksummed evidence or returns specific correction instructions.", "Verification records the comparison; it does not file a return, calculate a deadline, or prove official acceptance without the referenced external acknowledgement.", "Open Remittances", "vouchers:remittance_workspace"),
...
TREASURY_GUIDES = (
    ...
    },
    {
        ...
        "steps": (
            ...
            ("Record governed tax filing evidence", "For a homogeneous governed-tax batch, record the exact form, tax period, actual filing date/channel/reference, payment confirmation, reviewed GRAND tax source-schedule reference and SHA-256, and restricted evidence-custody reference.", "A checksum-backed draft is ready for independent Accounting verification.", "GRAND does not submit the return, calculate the deadline, or accept passwords and unnecessary taxpayer data. Mixed or generic deductions stay on the generic register.", "", ""),
