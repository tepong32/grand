...
REQUESTING_GUIDES = REQUESTING_GUIDES + (
    {
        ...
        "steps": (
            ...
            ("Read an exact work item when available", "For Field-operation cycle gates, named defects, readiness exercises, stakeholder/cutover decisions, and Local forms, read the stable Task ID, source reference, exact action and gate, permitted queue, scope, timing basis, source version, and exception before opening the record.", "The same source and action keep the same Task ID while applicable, while separate actions on one source remain distinguishable.", "The item does not copy, assign, approve, or complete the source record. A cycle action and each nested field record retain separate identities.", "Review My Work", "finance_operations:my_work"),
...
FINANCE_MY_WORK_GUIDES = {
    "accounting": {
        ...
        "steps": (
            ...
            ("Read an exact work item", "For Field-operation cycle gates, named defects, readiness exercises, stakeholder/cutover decisions, and Local forms, read the stable Task ID, controlled type, source reference, action, gate, permitted queue, timing basis, source version, and exception before opening the record.", "The same source and action keep the same Task ID while the action remains applicable, and separate actions on one source remain distinguishable.", "The item is a read-only pointer. A cycle gate and every nested field record keep separate identities; the overview does not create a second task or transaction.", "Review My Work", "finance_operations:my_work"),
