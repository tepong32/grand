...
- [Finance shadow operation, UAT acceptance, and controlled cutover](FINANCE_SHADOW_CUTOVER.md) explains F11.1 source/schema locks, exact comparison controls, owned defects, independent reconciliation, seven-party acceptance, explicit authority, rollback, floating guidance, and TraceSync evidence.
