...
- [Finance decisions and evidence register](FINANCE_DISCOVERY_DECISIONS.md) explains the F0.2 in-app evidence labels, cross-office ownership/review, exact-scope blockers, immutable snapshots, reasoned successors, cycle cutover gate, floating guidance, and TraceSync export.
