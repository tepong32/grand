...
- [Finance shadow operation, UAT acceptance, and controlled cutover](FINANCE_SHADOW_CUTOVER.md) explains F11.1–F11.3 transition controls: source staging/drift review, locally approved cadence, scheduled reconciliation snapshots, defect escalation/resolution, exact comparisons, seven-party acceptance, explicit authority, rollback, floating guidance, and TraceSync evidence.
