...
- [Finance decisions and evidence register](FINANCE_DISCOVERY_DECISIONS.md) explains the F0.2–F0.4 evidence labels, cross-office ownership/review, editable cycle coverage starters, acceptance examples, exact-scope blockers, immutable successors, cutover gates, floating guidance, and per-record/filtered-department TraceSync exports.
