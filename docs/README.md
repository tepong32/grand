...
- [Finance obligation control and RAAO-equivalent registry](FINANCE_OBLIGATION_CONTROL.md) explains requesting-office initiation, Budget certification, balance protection, modification limits, role-shaped triage, visible and certified-detail exports, and remaining local form acceptance.
- [Finance payable intake and obligation handoff](FINANCE_PAYABLE_INTAKE.md) explains F5.1 certified-obligation selection, payable evidence, department-safe case visibility, guided queue/register use, recoverable cross-database linkage, modification boundaries, and remaining F5 work.
...
- [Finance controlled DV printing and custody](FINANCE_CONTROLLED_PRINT_CUSTODY.md) explains F6.1 editable starter forms, checksum/versioned signing copies, guided custody-state triage, portable full print-history registers, TracePoint packet creation, wet-signature gates, reasoned reprints, and remaining local acceptance.
- [Finance transaction posting rules and governed JEV handoff](FINANCE_TRANSACTION_POSTING_RULES.md) explains F7.1 editable event rules, guided Accounting JEV triage, immutable rule snapshots, synchronized control-register export, balanced materialization, correction boundaries, and portable ledger/trial-balance exports.
...
- [Finance bank-statement intake and reconciliation](FINANCE_BANK_RECONCILIATION.md) explains F8.2/F8.5 checksummed statement versions, guided monthly triage, synchronized multi-statement export, posted-GL matching, prior-item carry/clearance lineage, adjusted-balance timing items, zero-difference independent review, starter CSV, floating guidance, and TraceSync-ready evidence exports.
- [Finance accountability reporting](FINANCE_ACCOUNTABILITY_REPORTING.md) explains F9.1 Budget accountability and posted-trial-balance starters, permission-preserving guided run triage, synchronized portable run registers, local-applicability controls, immutable report evidence, source drill-through, reproduction receipts, floating guidance, and TraceSync-ready exports.
...
- [Finance local-form inventory and acceptance](FINANCE_LOCAL_FORM_ACCEPTANCE.md) explains the F10.2 guided form queue, synchronized portable office register, in-app 31-form DBM candidate catalog, locally resolved dynamic sections, independently witnessed practical tests, maker–checker acceptance, reasoned successors, historical schema compatibility, and detailed portable evidence.
...
- [Finance shadow operation, UAT acceptance, and controlled cutover](FINANCE_SHADOW_CUTOVER.md) explains F11.1–F11.9 transition controls: source staging/drift review, locally approved cadence, scheduled reconciliation snapshots, defect escalation/resolution, curriculum/support planning, independently witnessed role/nonfunctional exercises, consecutive field-cycle qualification, exact F10.2 accepted-form lineage, structured two-store recovery evidence, field-acceptance coordination, guided cross-cycle triage, retained signed-decision references, seven-party acceptance, explicit authority, rollback, floating guidance, and TraceSync evidence.
- [Finance Field Acceptance Board](FINANCE_FIELD_ACCEPTANCE_BOARD.md) explains the filtered cross-cycle entry register, ten plain-language per-cycle checkpoints, role-bounded access, truthful percentage/authority boundary, correction behavior, and separate audited TraceSync-ready CSV status indexes.
...
- [Finance operations entry, shared-case finder, and private views](FINANCE_OPERATIONS_ENTRY.md) documents the implemented F1.2–F1.5 entry, search, private-filter, and work-attention foundation boundaries.
- [Finance work-attention foundation](FINANCE_MY_WORK.md) documents the permission-filtered cross-domain counts, exact source-queue drill-down rule, department guides, deliberately deferred adapters, and remaining item-level My Work contract.
- [Finance fiscal-year and classification foundation](FINANCE_FISCAL_FOUNDATION.md) documents the F2.1 typed year, calendar, effective-dated classifications, readiness layers, setup-release adoption, TraceSync-ready review register, role guidance, and synthetic acceptance procedure.
- [Finance opening balances and control-total intake](FINANCE_OPENING_BALANCES.md) documents the F2.2 staged import, reasoned correction, independent approval, opening-JEV posting, reconciliation, guided next-action queue, and synchronized control/row export workflow.
- [Finance annual budget preparation](FINANCE_ANNUAL_BUDGET.md) documents F3.1–F3.2 calls, ceilings, classified proposals and targets, resource estimates, consolidation, authorization, guided next-action triage, synchronized exports, and the non-spendable proposal boundary.
- [Finance allotment release control](FINANCE_ALLOTMENT_CONTROL.md) documents F4.1 release/reserve/deferral/adjustment movements, balance locks, independent posting, correction lineage, guided triage, and portable control/detail schedules.
