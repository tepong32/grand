...
- [Finance shadow operation, UAT acceptance, and controlled cutover](FINANCE_SHADOW_CUTOVER.md) explains F11.1 governed transition controls and F11.2 versioned redacted CSV staging, automatic locks, schema-drift review, exact comparisons, seven-party acceptance, explicit authority, rollback, floating guidance, and TraceSync evidence.
