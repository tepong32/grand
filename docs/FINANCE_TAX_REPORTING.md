...
These reports are controlled working schedules. They are not filed returns, issued certificates, proof of remittance, e-filing integrations, deadline calculators, or official form reproductions. An exact accepted layout must still pass the F10 template comparison/promotion controls and the parent F9/F11 field acceptance gates.
