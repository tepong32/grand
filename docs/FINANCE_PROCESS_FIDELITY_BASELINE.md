...
| 13 | Bank reconciliation, registers, ledgers, accountability reports, statements, and close | Budget, Accounting, Treasury | GL/trial balance/subsidiary controls, F8.2/F8.5 bank reconciliation lineage, F9.1–F9.7 reporting/package controls, F10.1 template promotion, and F10.2 local-form acceptance workflow implemented | **Implemented synthetic control; acceptance pending.** Populate actual local-form records and package profiles; perform witnessed golden/layout/signatory/overflow/accessibility/printer/recovery trials; confirm bank formats, ageing/escalation, bank-memo/JEV route, official BRS/reports/statements/tax forms, signatories/deadlines/copies; reproduce the complete signed/acknowledged package; and complete consecutive replay and period/year close. |
...
Use the [Finance local-form inventory and acceptance](FINANCE_LOCAL_FORM_ACCEPTANCE.md) workspace to retain the form-specific evidence from steps 2–5. Its existence does not convert synthetic starters into accepted LGU forms.
