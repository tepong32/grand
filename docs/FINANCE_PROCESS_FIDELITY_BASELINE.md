...
| 13 | Bank reconciliation, registers, ledgers, accountability reports, statements, and close | Budget, Accounting, Treasury | GL/trial balance/subsidiary controls, F8.2/F8.5 bank reconciliation lineage, F9.1–F9.6 governed reporting/tax evidence, and F9.7 cross-office accountability-package assembly implemented | **Implemented synthetic control; acceptance pending.** Populate locally accepted package profiles and confirm bank formats, ageing/escalation, bank-memo/JEV route, official BRS/reports/statements/tax forms, signatories/deadlines/copies, complete signed/acknowledged package reproduction, consecutive replay, and period/year close. |
