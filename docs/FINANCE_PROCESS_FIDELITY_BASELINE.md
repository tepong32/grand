...
| 12 | Advice, release, receipt, remittance, and unclaimed handling | Accounting and Treasury | Advice/release route, F8.1 withholding-remittance execution, and F8.3 policy-driven unclaimed/stale/returned classification implemented | **Partial.** Confirm exact office ownership, bank submission/acknowledgement, agency forms/deadlines, receipts, local thresholds, stop-payment/cancellation, returned-item Accounting, and correction rules. |
| 13 | Bank reconciliation, registers, ledgers, accountability reports, statements, and close | Budget, Accounting, Treasury | GL/trial balance/subsidiary controls plus F8.2 adjusted-balance bank reconciliation implemented | **Partial, acceptance pending.** Confirm bank formats, prior-item carry-forward/ageing, bank-memo/JEV route, official BRS, signatories/deadlines/copies, other reports/statements, and period/year close. |
