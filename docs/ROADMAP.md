...
The [Finance cross-cycle synthetic replay](FINANCE_CROSS_CYCLE_REPLAY.md) now connects one authoritative appropriation/allotment/obligation through payable intake, DV, recognition and payment JEVs, acknowledged check release, zero-difference bank reconciliation, and the controlled Treasury register. This closes the prior automated integration gap; it does not satisfy the parent local-form, field-replay, or named-office acceptance gates.
