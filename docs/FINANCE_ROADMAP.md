...
| Voucher Workbench | Shadow vertical slice through release plus F5.1 obligation handoff, F5.2 documentary readiness, and F5.3 relationship/recognition/export controls implemented | Complete accepted per-variant replay and exceptions, then add F6 print/version/custody gates without restoring a second budget balance. |
