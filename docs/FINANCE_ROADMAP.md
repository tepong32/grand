...
| Standalone Accounting | Fiscal/fund/account setup, controlled opening intake/posting/reconciliation/export, F7.1 rule-backed JEVs, and F7.2 immutable payable/withholding subsidiary controls with portable reconciliation evidence implemented | Continue under F7; orchestrate payment/remittance/cancellation events, broader subsidiary ledgers, period close, and statements. |
