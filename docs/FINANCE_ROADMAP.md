...
| Standalone Accounting | Fiscal/fund/account setup, controlled opening intake/posting/reconciliation/export, F7.1 transaction/event posting-rule snapshots, balanced journals, posting, GL, trial balance, and portable ledger exports implemented | Continue under F7; orchestrate payment/remittance/cancellation events, subsidiary ledgers, control reconciliation, closing, and statements. |
