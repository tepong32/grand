...
| Reporting/templates | Governed reporting, macro-free workbook preflight, F9.1 evidence/reproduction controls, the F9.2 operational catalog, F9.3 governed statement composition/explained measures, F9.4 note/reference controls, F9.5–F9.6 governed tax schedules/filing evidence, F9.7 accountability-package assembly, and F10.1 governed template promotion/rollback exist | Populate accepted package profiles; confirm actual forms, filing/remittance evidence, and TIN custody; reproduce a complete signed/acknowledged package; and complete exact local-form, printer, golden-output, and named-office acceptance through F9–F11. |
