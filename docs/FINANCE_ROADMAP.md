...
| Shadow operation and cutover | F11.1 governed cycles/cutover, F11.2 source staging/drift controls, F11.3 approved cadence/run/defect gates, and F11.4 curriculum/support plus witnessed readiness-exercise gates implemented | Confirm local plan/content/pass-condition values, any production adapter, complete actual exercises, consecutive local field cycles, and actual seven-party approval before claiming authority. |
