...
Last reviewed: 2026-09-08, v0.7.25 personal voucher posting handoffs.
...
| Payable intake and shared voucher processing | Review/DV preparation (v0.7.21), plus signatures and independent validation (v0.7.23) and Accounting posting (v0.7.25). Later stages remain to audit | Retained payable submission/return/acceptance events (v0.7.21) |
