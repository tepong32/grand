...
Last reviewed: 2026-09-08, v0.7.26 Treasury/advice personal handoffs.
...
| Payable intake and shared voucher processing | Review/DV preparation (v0.7.21), plus signatures and independent validation (v0.7.23) Accounting posting (v0.7.25), Treasury preparation and advice (v0.7.26). Later stages remain to audit | Retained payable submission/return/acceptance events (v0.7.21) |
...
| Payment instruments | Shared case through Treasury preparation/advice; issuer attribution during advice (v0.7.26). Release/exception handoffs remain | Remaining coverage |
