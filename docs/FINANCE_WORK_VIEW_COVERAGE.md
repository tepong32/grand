...
Last reviewed: 2026-09-08, v0.7.27 release/event-posting handoffs.
...
| Payment instruments | Shared case through Treasury/advice/release/event posting (v0.7.27); returned-item-specific handoffs remain | Remaining coverage |
