...
v0.7.104 development checkpoint: [unpaid original advance corrections](FINANCE_ADVANCE_RECOGNITION_CORRECTIONS_IN_PROGRESS.md), D-089, connect independently posted reversal, reviewed Budget/payable changes, fresh DV signatures and replacement recognition/payment. The later `continue` supersedes the nightly pause. Full SQLite and native workflow/Budget validation pass; paid/instrument corrections and full Finance acceptance remain open.

v0.7.103 development checkpoint: [posted expense-liquidation corrections](FINANCE_LIQUIDATION_CORRECTIONS_2026-09-13.md), D-088, connect exact independent reversal, dated restoration, corrected expense replacement or actual refund, recovery and retained output history. Original recognition corrections and other advance scenarios remain open. The feature record gives validation and limits. This published checkpoint completed the earlier nightly request; implementation has resumed. Full Finance and production acceptance remain unfinished.
...
status. D-088 adds expense-liquidation correction; original-recognition correction,
all advance scenarios, exact official forms and full Finance completion remain open.
...
cash refunds and expense corrections follow in D-087/D-088; original recognition corrections remain open.

The [expense-liquidation route](FINANCE_ADVANCE_LIQUIDATIONS_2026-09-12.md), D-086, now selects the original recognized officer advance, verifies actual releases and applies explicit expense rows under dated reservations and independent posting. Native web/output, standard-role and reservation/materialization/posting/payment-recovery races are covered. Cash-refund coverage follows in D-087 above; original recognition corrections, other recognition/application scenarios and all exact-form/office/operational/LGU gates remain incomplete. This is not full M03 or Finance completion.
...
v0.7.88 shared-historical development checkpoint (full-project regression passed): [shared schedules and DV evidence](FINANCE_SHARED_APPLICATIONS_IN_PROGRESS.md) now demonstrate HTTP source/invoice entry and independent approval through deductions, settlement, partial instruments, returns/corrections, interrupted recovery and retained outputs across distinct original credits. M02 remains open for safe generated-history adoption and later corrections. The separate actual inventory, M01/M03, exact local forms and operational/LGU gates remain unmet.

Current v0.7.87: [reviewed invoice allocations](FINANCE_HISTORICAL_SPLITS_IN_PROGRESS.md) connect ordinary split-proposal entry and independent approval to invoice DV settlement/corrections and retained claim/subsidiary outputs. This covers invoices within one original credit; shared applications across distinct credits, generated-history adoption and remaining corrections keep M02 open. The feature record contains full-project, native and browser evidence; M01/M03, actual inventory, exact forms and real operational/LGU acceptance remain separate incomplete requirements.
