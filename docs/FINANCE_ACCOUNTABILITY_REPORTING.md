...
F9.2 supplies the first [Finance operational report catalog](FINANCE_OPERATIONAL_REPORT_CATALOG.md): Budget-versus-posted-actual, posted general ledger, payable/withholding schedules, and a Treasury disbursement register. F9.3 adds [governed statement composition and explained measures](FINANCE_STATEMENT_CONTROLS.md), F9.4 adds [statement notes and signed-reference control comparison](FINANCE_STATEMENT_NOTES.md), F9.5 adds [governed tax withholding capture and reporting](FINANCE_TAX_REPORTING.md), F9.6 adds [tax remittance and filing evidence](FINANCE_TAX_REMITTANCE_EVIDENCE.md), and F9.7 adds [governed accountability-package profiles and assembly](FINANCE_ACCOUNTABILITY_PACKAGES.md). The [F9 comprehensive review](FINANCE_F9_REVIEW_AND_HANDOFF.md) records the software-control position and remaining gate evidence. F10.1 adds [governed visual template promotion and rollback](FINANCE_TEMPLATE_PROMOTION.md). F9 remains open for current locally accepted package contents and forms, actual filing/deadline evidence, exact layouts, complete signed/acknowledged package replay, and named-office acceptance; F10 remains open for actual local-form, printer, overflow, golden-output, and named-office acceptance.
