...
F9.2 supplies the first [Finance operational report catalog](FINANCE_OPERATIONAL_REPORT_CATALOG.md): Budget-versus-posted-actual, posted general ledger, payable/withholding schedules, and a Treasury disbursement register. F9.3 adds [governed statement composition and explained measures](FINANCE_STATEMENT_CONTROLS.md), F9.4 adds [statement notes and signed-reference control comparison](FINANCE_STATEMENT_NOTES.md), and F9.5 adds [governed tax withholding capture and reporting](FINANCE_TAX_REPORTING.md). F10.1 adds [governed visual template promotion and rollback](FINANCE_TEMPLATE_PROMOTION.md). F9 remains open for current locally accepted tax/BIR forms, filing/remittance evidence, exact layouts, complete signed-package replay, and named-office acceptance; F10 remains open for actual local-form, printer, overflow, golden-output, and named-office acceptance.
