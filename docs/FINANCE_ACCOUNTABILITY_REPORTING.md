...
F9 remains open for the full finance report catalog, financial statements and notes, check/disbursement and tax schedules, dashboard definitions, supersession, and signed-reference reproduction. F10 remains responsible for exact official-form mapping and non-developer template promotion.
