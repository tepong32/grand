...
## Current v0.7.51 checkpoint - DV amendment owner authority

Branch: `codex/finance-dv-amendment-authority`, based on pushed `46d5843`. Non-financial DV amendment now requires an explicitly authorized active non-UAT actor in the stored case's pinned Finance Setup office. The service and source control share this boundary, including idempotent replay. Owning Accounting may still amend after Treasury handoff before instrument issuance; permitted fields, financial totals and posted JEV evidence remain unchanged. All 69 focused voucher-workflow tests passed in 42.735 seconds; all 668 project tests passed in 272.103 seconds. System, migration-drift, compilation and diff checks passed. FIN-GAP-024 verified; D-041 records the pinned-owner decision and future delegation boundary. Next: reproduce FIN-GAP-025 controlled-reprint amendment lineage, then detailed DV print/packet/amendment and posting/synchronization/reopen history. Preserve the user database.
