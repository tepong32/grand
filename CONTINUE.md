...
## Current v0.7.52 checkpoint - Amendment-aware controlled reprint lineage

Branch: `codex/finance-amendment-reprint-lineage`, based on pushed `1604240`. Controlled reprints preserve the selected signatory and custody snapshots from the superseded printed round. Replacement signatures complete a pending amendment only through retained same-case, descending-version print lineage; broken linkage rolls back the final signature. Original amendment rounds, financial snapshots and superseded copies remain intact. All 76 focused voucher/signature tests passed in 43.931 seconds. All 670 project tests passed in 272.577 seconds. System, migration-drift, compilation and diff checks passed. FIN-GAP-025 verified; D-042 records the retained-lineage decision. Next: reproduce FIN-GAP-026 return-correction print/amendment supersession, then detailed DV print/packet/amendment personal history and posting/synchronization/reopen coverage. Preserve the user database.
