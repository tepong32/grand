...
Individual payable claims use original posted liability credits and linked applications on the existing journal. Check dated capacity under source-credit locks and new claim identities under the existing fund lock; retain exact reversal lineage. Do not infer historical invoice allocation or treat a payee aggregate/manual claim schedule as completed DV settlement or cash reservation. See [claim ledger and remaining integration](docs/FINANCE_PAYABLE_CLAIMS_2026-09-10.md).
