...
urlpatterns = [
    ...
    path("allotments/export/", views.allotment_register_export, name="allotment_register_export"),
    ...
    path("obligations/control-register/export/", views.obligation_register_export, name="obligation_register_export"),
